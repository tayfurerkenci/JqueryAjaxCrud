...
namespace JqueryAjax.CoreCrud.Models
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<VwHugee> VwHugees { get; set; }
        public virtual DbSet<VwLondonerEmployee> VwLondonerEmployees { get; set; }
...
//        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<VwHugee>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("VwHugee");
            ...
            modelBuilder.Entity<VwLondonerEmployee>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("VwLondonerEmployee");
